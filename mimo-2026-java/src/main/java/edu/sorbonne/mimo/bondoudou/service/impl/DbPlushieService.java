...
public class DbPlushieService implements PlushieService {
    ...
    public void create(Plushie plushie) {
        BrandEntity brand = brandRepository.findByName(plushie.brandName())
                .orElseThrow(() -> new IllegalArgumentException(
                        "Brand not found: " + plushie.brandName()));
    ...
    public Plushie update(Long id, Plushie updatedPlushie) {
        ...
        BrandEntity brand = brandRepository.findByName(updatedPlushie.brandName())
                .orElseThrow(() -> new IllegalArgumentException("Brand not found: " + updatedPlushie.brandName()));
